...
INSERT INTO pilots (last_name, first_name, license_number, rank) VALUES
('Иванов', 'Иван', 'L-12345', 'Captain');

INSERT INTO flights (flight_number, departure_airport_code, arrival_airport_code, scheduled_departure, scheduled_arrival, status, gate, aircraft_id) 
VALUES 
('SU-100', 'SVO', 'LED', NOW() - INTERVAL '30 minutes', NOW() + INTERVAL '30 minutes', 'departed', 'B12', 1),
('SU-520', 'SVO', 'DXB', NOW() + INTERVAL '2 hours', NOW() + INTERVAL '7 hours', 'check_in', 'D05', 2),
('TK-412', 'SVO', 'IST', NOW() + INTERVAL '1 day', NOW() + INTERVAL '1 day 4 hours', 'scheduled', NULL, NULL);
